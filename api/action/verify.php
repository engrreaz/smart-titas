...
// Support both Form Data (from App) and JSON input
...
// Map singular app types to plural table names
$type_map = [
    'official' => 'officials',
...
if (!$item_type || !in_array($item_type, $allowed_tables) || !$item_id || $verification_level === null) {
    ...
    sendResponse(["status" => "error", "message" => "Invalid or missing parameters. Type: $item_type"]);
}
