...
try {
    // টেবিলের নাম emergency_contacts (Instruction.md অনুযায়ী)
    $stmt = $conn->prepare("SELECT * FROM emergency_contacts WHERE UNIX_TIMESTAMP(updated_at) > ? AND status = 'approved'");
