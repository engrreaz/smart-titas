...
try {
    // টেবিল নাম tourism_places এবং সরাসরি রেকর্ড পাঠানো হচ্ছে
    $stmt = $conn->prepare("SELECT * FROM tourism_places WHERE UNIX_TIMESTAMP(updated_at) > ? AND status = 'approved'");
